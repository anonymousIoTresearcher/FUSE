...
if __name__ == '__main__':
    ...
    db = MARSNShot('MARS', batchsz=20, n_way=5, k_shot=200, k_query=200, imgsz=14)
...
# data = np.load(os.path.join('MARS', 'features_list.npy'), allow_pickle=True)

# labels = np.load(os.path.join('MARS', 'df_kinect_list.npy'), allow_pickle=True)
...
# np.save('MARS/bigUC_data.npy', train_data)
# np.save('MARS/bigUC_labels.npy', train_labels)
# np.save('MARS/smallUC_data.npy', test_data)
# np.save('MARS/smallUC_labels.npy', test_labels)
